...
<h4><i class="icon-reorder"></i> edit blog post</h4>
<span class="tools">
...
<!-- BEGIN FORM-->
<form action="{{route('update-blog')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
	@csrf
    <div class="control-group">
        <label class="control-label">blog title</label>
        <div class="controls">
            <input type="text" name="blog_title" value="{{$blog->blog_title}}" class="input-xxlarge" />
            <input type="hidden" name="id" value="{{$blog->id}}" class="input-xxlarge" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <textarea class="input-xxlarge" name="blog_description" rows="3">{{$blog->blog_description}}</textarea>
     ...
     <div class="control-group">
            ...
            <div class="controls">
                <label class="radio">
                    <input type="radio" name="publication_status" value="1" {{$blog->publication_status == 1 ? "checked" : ""}}/>
                    publish
                </label>
                <label class="radio">
                    <input type="radio" name="publication_status" value="0" {{$blog->publication_status == 0 ? "checked" : ""}} />
                    unpublish
                </label>
        ...
        <div class="controls">
              ...
              <img src="{{asset($blog->blog_image)}}" width="80px" height="80px">
