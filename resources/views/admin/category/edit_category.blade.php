...
<div class="widget-body">
    ...
    <form action="{{route('update-category')}}" method="post" class="form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="category_name" value="{{$category->category_name}}" class="input-xlarge" />
                 <input type="hidden" name="id" value="{{$category->id}}" class="input-xlarge" />
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <label class="radio">
                    <input type="radio" name="publication_status" value="1" {{$category->publication_status == 1 ? "checked" :""}}/>
                    publish
                </label>
                <label class="radio">
                    <input type="radio" name="publication_status" value="0"  {{$category->publication_status == 0 ? "checked" :""}} />
                    unpublish
                </label>
