...
<body class="fixed-top">
                   ...
                   <ul class="nav pull-right top-menu" >
                       ...
                       <li class="dropdown">
                           ...
                           <ul class="dropdown-menu extended logout">
                               ...
                               <li><a href="" onClick="event.preventDefault();document.getElementById("logoutform").submit();"><i class="icon-key">
         ...
         <!-- BEGIN SIDEBAR MENU -->
          <ul class="sidebar-menu">
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a class="" href="{{route('add-category')}}">add category</a></li>
                      <li><a class="" href="{{route('manage-category')}}">manage category</a></li>
                ...
                <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a class="" href="{{route('add-blog')}}">add blog</a></li>
                      <li><a class="" href="{{route('manage-blog')}}">manage blog</a></li>
   ...
   <script type="text/javascript" src="{{asset("admin/assets/jquery-slimscroll/jquery-ui-1.9.2.custom.min.js")}}"></script>
   <script type="text/javascript" src="{{asset("admin/assets/jquery-slimscroll/jquery.slimscroll.min.js")}}"></script>
   <script src="{{asset("admin/assets/fullcalendar/fullcalendar/fullcalendar.min.js")}}"></script>
   ...
   <script src="{{asset("admin/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js")}}" type="text/javascript"></script>
   ...
   <script src="{{asset("admin/js/home-page-calender.js")}}"></script>
